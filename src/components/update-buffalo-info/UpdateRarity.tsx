...
interface UpdateRarityDialogProps {
  metadata: IMetadata;
}
...
const UpdateRarityDialog = ({ metadata }: UpdateRarityDialogProps) => {
  ...
  return (
    <dialog id="upload_rarity_dialog" className="modal">
      <div className="modal-box">
        <h3 className="text-lg font-bold">แก้ไข rarity</h3>
...
export default UpdateRarityDialog;
